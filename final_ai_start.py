#!/usr/bin/env python3
"""
FINAL AI START - Proper Port Selection Order
"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("AETHER MULTI-AGENT BOT - AI STARTUP")
    print("=" * 60)
    
    # 1. Initialize AI models FIRST
    print("Initializing AI models...")
    init_ai_models()
    print(f"Initialized {len(ai_models)} AI models: {list(ai_models.keys())}")
    
    # 2. Find available port SECOND
    ...
    print("=" * 60)
    print(f"SUCCESS: Clean Google GenAI - Starting on port {port}")
    print("=" * 60)
